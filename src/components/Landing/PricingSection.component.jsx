                    ...
                    <div className="pricing-container">
						...
						>
                            ...
                            >
                                ...
                                <p><a to="#contact"  onClick={() => handlePricing('Small Project')} className="highlight">Choose Small project</a></p>
						...
						>
                            {({ isVisible }) => (
                                ...
                                >
                                    ...
                                    <p><a to="#contact" onClick={() => handlePricing('Medium Project')} className="highlight">Choose Medium project</a></p>
                                    <span className="money">$$</span>
                                </motion.div>
                            )}
                        </VisibilitySensor>
						...
						>
                            {({ isVisible }) => (
                                ...
                                >
                                    ...
                                    <p><a to="#contact"  onClick={() => handlePricing('Business Project')} className="highlight">Choose Business</a></p>
                                    <span className="money">$$$</span>
                                </motion.div>
                            )}
                        </VisibilitySensor>
